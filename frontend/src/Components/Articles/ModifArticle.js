...
const ModifArticle = (props) => {
  ...
  useEffect(() => {
    ...
    setImageartpetitf(article.imageartpetitf);
    setCategorieID(article.categorieID);
  ...
  const AfficheModalFiltreCateg = () => {
    setTypemodal("filtreCategorie");
    setOpen(true);
  };

  const handleCatId = (idcat) => {
